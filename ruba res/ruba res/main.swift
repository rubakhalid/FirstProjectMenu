...
Welcome to (Ruba) Restaurant, which serves Indian cuisine from the freshest ingredients and wonderful Indian spices ❤️
...
//
//"""
 var shoppingList: [String] = ["1.Main Course 🍱 ","2.Appetizers 🥧","3.Desserts 🍮","4.Drink 🍻 " ]
for (index,element) in shoppingList.enumerated() {
    print(element)
          }

//for index in Menu2.indices {
//    print("\(Menu2[index])",
//          terminator: " ")}
